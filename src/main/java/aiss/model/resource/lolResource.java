...
public class lolResource {
	private static final String OMDB_API_KEY = "RGAPI-68413756-87fb-475e-9ba2-8773bb3d5840";  
	...
	public Player getPlayer(String region,String name){
		String uri3 = "https://"+region+".api.riotgames.com/lol/summoner/v4/summoners/by-name/" + name + "?api_key="+ OMDB_API_KEY;
	...
	public List<lolmatchsxid.Match> getPartidas(String region,String accountid){
		String uri2 = "https://"+region+".api.riotgames.com/lol/match/v4/matchlists/by-account/" + accountid + "?api_key="+ OMDB_API_KEY;

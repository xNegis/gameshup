...
<table class="table table-condensed" style="border-collapse:collapse;">
    ...
    <tbody>
        <tr data-toggle="collapse" data-target="#demo<%=cont%>" class="accordion-toggle">
                  <td><button class="btn btn-default btn-xs" ><span class="glyphicon glyphicon-menu-down"></span><img src="img/pngocean.com.png"  width="20" height="20" /></button></td>
           
            <td>Campeon : <c:out value="${entry.champion}" /></td>
            <td>Kills : <c:out value="${entry.kills}" /></td>
            <td>Muertes : <c:out value="${entry.deaths}" /></td>
        </tr>
        ...
        <tr>
            <td colspan="12" class="hiddenRow"><div class="accordian-body collapse" id="demo<%=cont%>"> 
              ...
              <table class="table table-striped">
                      <thead>
                                  <img src="img/champion/${entry.champion}.png" class="mr-3" alt="..." width="70" height="70">                       
                      
						Farm : <c:out value="${entry.minions}" /> 	|
                        Asistencias : <c:out value="${entry.assists}" /> 	|
						Damage : <c:out value="${entry.dmg}" />	 |
                      </thead>
                      <tbody>
